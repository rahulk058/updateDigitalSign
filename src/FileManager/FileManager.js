...
import FolderBar from '../FileManager/FolderBar';
import TopBar from '../FileManager/TopBar';
import ContainerBar from '../FileManager/ContainerBar';
import PopupDialog from '../FileManager/Elements/PopupDialog';
import config from '../FileManager/Elements/config.json';
import mainconfig from '../Data/Config';
import { convertDate, formatBytes } from '../Utils/Utils';
import ImageEditor from '../FileManager/Elements/ImageEditor';
import PerfectScrollbar from 'react-perfect-scrollbar';
import '../FileManager/Assets/PerfectScroll.css';
...
const useStyles = makeStyles(theme => ({
    ...
    folderSide: {
        flexGrow: 1,
        background: '#f9fafc',
        borderRight: '1px solid #b4b4b7',
        // borderLeft: '1px solid #b4b4b7'
    },
    paper: {
...
function FileManager(props) {
    ...
    const aviableButtons = {
        topbar:[
            ...
            [allButtons.newFolder, allButtons.uploadFile, allButtons.reload],
            [allButtons.delete,  allButtons.dubplicate],
            [allButtons.rename, allButtons.editImage],
            [allButtons.inverseSelected, allButtons.selectNone, allButtons.selectAll],
            [allButtons.preview, allButtons.getInfo,  allButtons.download],
